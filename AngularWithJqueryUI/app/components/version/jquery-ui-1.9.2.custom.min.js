...
(function ($) {
    ...
    $(document).on("click", ".ui-datepicker-current", function () {
        $(datepicker_CurrentInput).datepicker("hide").datepicker("setDate", new Date()).blur();
    });
